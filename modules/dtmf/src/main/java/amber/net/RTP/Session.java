        ...
        import amber.net.RTP.Packets.RTCPBYEPacket;
        import amber.net.RTP.Packets.RTCPReceiverReportPacket;
        import amber.net.RTP.Packets.RTCPSDESPacket;
        import amber.net.RTP.Packets.RTCPSenderReportPacket;
        import amber.net.RTP.Packets.RTCP_actionListener;
     ...
     public class Session extends java.lang.Object
        {
            ...
            *
            */
            public  static RTPThreadHandler         m_RTPHandler = null;
            ...
            *
            */
            public  static RTCPThreadHandler        m_RTCPHandler = null;
            ...
            */
            ...
            /**
            *   Reference to the Late Initialization Client.
            *
            */
            ...
            */
            public static Vector InitializationData = new Vector();
            ...
            public synchronized static InetAddress GetInetAddress ( String MulticastAddress )
            {
        	    ...
        	    try
        	    {
                	...
                	catch (UnknownHostException e)
                	{
                	    ...
                	    ia = InetAddress.getLocalHost();//newInetAddress ( MulticastAddress );
                	}
                }
                catch (Exception e)
                {
        ...
        */
          ...
          */
          ...
          /**
          * Sends an RTP Packet.
          * @param data The RTP payload.
          */
          public void SendRTPPacket ( byte [] data )
          {
            if ( m_RTPHandler != null )
                m_RTPHandler.SendPacket( data );
            else    
          ...
          * RTP receiver thread.  This function calls the thread startup functions which
          * could also be called manually if needed.  This function is an alternative
          * for calling the following
          * StartRTCPSenderThread();
          * StartRTCPReceiverThread();
          * StartRTPReceiverThread();
          * 
          * @see Session#StartRTCPSenderThread
          * @see Session#StartRTCPReceiverThread
          * @see Session#StartRTPReceiverThread
          */
          public void Start ()
          {
            StartRTCPSenderThread();
          ...
          /**
          * Stops the session and terminates the RTCP sending loop by forcing a bye packet.
